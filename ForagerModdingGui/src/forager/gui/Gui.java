...
public class Gui extends JFrame {
	...
	public static PanelSpriteCreate panelSpriteCreate;
	public static PanelItemCreate panelItemCreate;
	
	private PanelBottom panelBottom;
	private JTextField txtDescription;
	
	public static JPanel currentPanel;
	public static String sm = "Something";
	private static int pointer = 0;
	
	private static ArrayList<JPanel> panelArray = new ArrayList<JPanel>();
	...
	public Gui() {
		...
		panelItemCreate = new PanelItemCreate();
		
		panelArray.add(panelSpriteCreate.getPanelSpriteCreate());
		panelArray.get(0).setName("SpriteCreate");
		panelArray.add(panelItemCreate.getPanelItemCreate());
		panelArray.get(1).setName("ItemCreate");
		
		
		currentPanel = panelArray.get(0);
	...
	public static void setCorrectPanel() {
		
		if (PanelBottom.lastBtn.equals("btnContinue")) {
			//currentPanel.removeAll();
			//currentPanel.repaint();
			pointer++;
			setCurrentPanel(panelArray.get(0));
			//contentPane.add(currentPanel);
			contentPane.add(currentPanel);
			contentPane.repaint();
		...
		else if (PanelBottom.lastBtn.equals("btnBack")) {
			
		}
		//pointer++;
		//currentPanel = panelArray.get(1);
		//currentPanel.setVisible(true);
		//panelItemCreate.getPanelItemCreate().setVisible(true);
